...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference("ShortUrl.count") do
      post short_urls_url, params: { short_url: { hash_key: @short_url.hash_key, long_url: @short_url.long_url } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { hash_key: @short_url.hash_key, long_url: @short_url.long_url } }
